...
def compute_changes(current_obo_url, previous_obo_url):
    ...
    report["summary"] = {
        ...
        "changes" : {
            ...
            "biological_process_terms" : len(currentgo.get_terms_in("biological_process") - oldgo.get_terms_in("biological_process")),
            "molecular_function_terms" : len(currentgo.get_terms_in("molecular_function") - oldgo.get_terms_in("molecular_function")),
            "cellular_component_terms" : len(currentgo.get_terms_in("cellular_component") - oldgo.get_terms_in("cellular_component")),
